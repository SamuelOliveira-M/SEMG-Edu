...
studentRoutes.get("/grad/:registrationId",ReadGradeController.readRegistrationNotesController)
studentRoutes.get("/grade/:registrationId",ReadSubjectOfGradeController.gradesBySubject)
